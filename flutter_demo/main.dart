...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: CalculatorDemo(title: 'Flutter Demo Home Page'),
    );
  }
}
...
class CalculatorDemo extends StatefulWidget {
  ...
  CalculatorDemo({Key key, this.title}) : super(key: key);

  @override
  _CalculatorState createState() => _CalculatorState();
}

class _CalculatorState extends State<CalculatorDemo> {
...
class CalcDisplay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Text(
        content,
        style: const TextStyle(fontSize: 50.0, color: Colors.teal),
      ),
    );
  }
}
